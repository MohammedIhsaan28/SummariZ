...
export default function UploadHeader() {
  return (
    <div className="flex flex-col items-center justify-center gap-6 text-center">
      <MotionDiv variants={itemVariants} className="relative p-[1px] overflow-hidden rounded-full bg-linear-to-r from-cyan-200 via-cyan-500 to-cyan-800 animate-gradient-x group">
        <Badge
          variant={"secondary"}
        ...
        >
          ...
          <p className="text-cyan-500">AI-powered Content Creation</p>
        </Badge>
      </MotionDiv>
