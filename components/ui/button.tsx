...
// When not using asChild, allow Framer Motion's button props
type MotionButtonProps = HTMLMotionProps<"button"> &
  VariantProps<typeof buttonVariants> &
  BaseProps & { asChild?: false };

// When using asChild (rendering Slot), allow regular button props but drop HTML onDrag to avoid conflict
type SlotButtonProps = Omit<
  React.ButtonHTMLAttributes<HTMLButtonElement>,
  "onDrag"
> &
  VariantProps<typeof buttonVariants> &
  BaseProps & { asChild: true };
      ...
      return (
        <Slot
          ...
          className={cn(
            ...
            "text-white hover:text-emerald-200 relative overflow-hidden"
          )}
          style={{
