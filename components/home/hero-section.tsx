  ...
  return (
    ...
    >
      <MotionDiv
        ...
        className="relative p-[1px] overflow-hidden rounded-full bg-gradient-to-r from-cyan-200 via-cyan-500 to-cyan-800 animate-gradient-x group"
      >
        <Badge
          variant="secondary"
          className="relative px-6 py-2 text-base font-medium bg-white rounded-full group-hover:bg-cyan-100 transition-colors duration-200"
        >
          <Sparkles className="h-6 w-6 mr-2 text-cyan-600 animate-pulse" />
          <span className="text-base text-cyan-600">Powered by AI</span>
        </Badge>
      </MotionDiv>
      ...
      >
        Get a beautiful summary reel of the document
      </MotionH2>
      ...
      <MotionDiv variants={itemVariants} whileHover={buttonVariants}>
        <Button
          ...
          className="text-white mt-6 text-base sm:text-lg lg:text-xl rounded-full px-8 sm:px-10 lg:px-12 py-6 sm:py-7 lg:py-8 lg:mt-16
             hover:no-underline font-extrabold shadow-lg transition-all duration-300"
        >
